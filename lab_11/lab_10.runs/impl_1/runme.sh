...
HD_PWD='C:/Users/hira6/Downloads/Task_c_done_sarah/Task_c_done_sarah/lab_11_final/lab_11/lab_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_for_task_A.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_for_task_A.tcl -notrace
