`timescale 1ns / 1ps
// =============================================================================
// TopLevelProcessor_taskb
// Identical to TopLevelProcessor except uses instruction_mem_taskb_simple.
// Only this one line differs from your working processor.
// =============================================================================
module TopLevelProcessor_taskb (
    input  wire        clk,
    input  wire        reset,
    ...
    // *** ONLY CHANGE FROM ORIGINAL: instruction memory module ***
    instruction_mem_taskb_simple u_iMem (
